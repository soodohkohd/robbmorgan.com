...
export const routes: Routes = [
  ...
  },
  {
    ...
    data: { description: 'Thirty years of technology leadership. Principal AI Architect. Cross-industry consulting, enterprise pipelines, cloud, regulated environments, AI strategy.' },
  },
  {
    path: 'novels',
