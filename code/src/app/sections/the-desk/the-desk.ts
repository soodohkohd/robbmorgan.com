  ...
  readonly chapters: readonly Chapter[] = [
    ...
    },
    {
      ...
      bodyHtml: `
        ...
        <p>What I haven't lost count of is the number of times I sat back, looked at the scene, and saw it just <em>work</em> — the birds arcing past behind the monitor, the steam billowing over the mug, the typewriter ticking out fake code, the notification fading in and out on the phone, and the window beyond the desk showing the right time of day for whatever moment I happened to be looking. Every one of those moments was paid for in hours of struggle. Every one was worth it.</p>
