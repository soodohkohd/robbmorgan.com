  ...
  readonly posts: readonly Post[] = [
    {
      ...
      bodyHtml: `
        ...
        <p>You can watch it happen in any planning meeting. The board asks what the AI strategy is. A competitor ships a chatbot. By the next sprint, every roadmap has grown an "AI-powered" line item, and half of them are a process that already worked, now wearing a language model it never needed. The feature did not get better. It got a press release.</p>
        ...
        <p>The same line runs through every system I have built. Deciding which support ticket is urgent is judgment. Calculating the refund is not. Drafting the first pass of a job posting is judgment. Deciding who gets the interview is not. Summarizing a contract is judgment. Enforcing what it says is not. The trouble starts the moment someone slides AI across that line because it looked good in a demo.</p>
